...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;user=root;password=\"ne vzlomaesh lox4444\";database=spa_salon", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.36-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Master>(entity =>
        {
            ...
            entity.HasIndex(e => e.MasterUserId, "master_user_userId_fk");
            ...
            entity.HasOne(d => d.MasterUser).WithMany(p => p.Masters)
                .HasForeignKey(d => d.MasterUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("master_user_userId_fk");
        });
